  ...
  var SocialCount = {
    ...
    bindEvents: function( $el, url, facebookAction, isSmall ) {
      ...
      if( !isSmall ) {
        ...
        bind( $el.find( SocialCount.selectors.facebookShare + ' a' ),
          '<a class="fb-count-share" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fparse.com" target="_blank">Share on Facebook</a>', '//apis.google.com/js/plusone.js' );
